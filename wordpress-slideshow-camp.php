...
function wp_s_camp_enqueue_styles(){
    wp_enqueue_style( 'wp-s-camp-css', plugins_url( 'css/wp_slide.css' , __FILE__ ));
...
function wp_s_camp_custom_cssjs(){
	wp_enqueue_script( 'wp-s-camp-js', plugins_url( 'js/wp_slide.js' , __FILE__ ));
}
